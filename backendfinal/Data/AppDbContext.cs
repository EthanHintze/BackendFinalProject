...
public partial class AppDbContext : DbContext
{
    ...
    {
        modelBuilder.HasPostgresEnum("warehouse", "alphabet_enum", new[]
        {
        ...
        modelBuilder.Entity<BinLocation>(entity =>
        {
            ...
            // ✅ One bin = one product (DB-level unique constraint)
            entity.HasIndex(bl => bl.BinId).IsUnique();
        });
        ...
        // ✅ Unique username at DB level
        modelBuilder.Entity<User>()
            .HasIndex(u => u.Username).IsUnique();

        // ✅ CustomerOrder status default
        modelBuilder.Entity<CustomerOrder>()
            .Property(o => o.Status).HasDefaultValue("CREATED");

        // ✅ CustomerOrder → Customer FK
        modelBuilder.Entity<CustomerOrder>()
            .HasOne(o => o.Customer)
            .WithMany(c => c.Orders)
            .HasForeignKey(o => o.CustomerId);

        // ✅ CustomerOrderItem → CustomerOrder FK
        modelBuilder.Entity<CustomerOrderItem>()
            .HasOne(oi => oi.Order)
            .WithMany(o => o.OrderItems)
            .HasForeignKey(oi => oi.OrderId);

        // ✅ CustomerOrderItem → Item FK
        modelBuilder.Entity<CustomerOrderItem>()
            .HasOne(oi => oi.Item)
            .WithMany()
